...
//      String redir="https://www.douban.com/people/144537495/";
        ...
        //输入用户名及密码
        String form_email="akiyamamio11@126.com";
        String form_password="dianjgis11";
        //获取验证码
    ...
    private static void downImg(String src) throws IOException{
        File fileDir=new File("C:/Users/xuwei/Desktop/img");
        if(!fileDir.exists()){
            fileDir.mkdirs();
        }
        //图片下载保存地址
        File file=new File("C:/Users/xuwei/Desktop/img/yzm.png");
        if(file.exists()){
            file.delete();
        }
